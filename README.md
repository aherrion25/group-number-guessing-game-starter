...
- [x] create an input field for each of the Players to make a guess
- [x] create an submit guesses button (submits all guesses at the same time)
- [x] create a total guesses made indicator (think of this as rounds in a game)
- []create a details area for the history of guesses for each player (tell them if their last guess was too low or too high)
